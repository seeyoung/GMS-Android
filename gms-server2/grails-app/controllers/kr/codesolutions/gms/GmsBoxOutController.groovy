...
class GmsBoxOutController {
    ...
    def index(Integer max, String sort, String order) {
		...
		def gmsMessageInstanceList = GmsBoxOut.list(params)*.message
        respond gmsMessageInstanceList, model:[gmsMessageInstanceCount: GmsBoxOut.count()]
    }
    ...
    @Transactional
    def delete(GmsBoxOut gmsMessageOutBoxInstance) {
